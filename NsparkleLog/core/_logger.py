...
from NsparkleLog.dependencies import threading , stderr , inspect , os , traceback , multiprocessing , functools , datetime as dt , time
...
class Logger:
    ...
    def exception(self, exception: Exception, **kwargs) -> None:
        ...
        self._log(Levels.ERROR, err_msg, **kwargs) #type: ignore
